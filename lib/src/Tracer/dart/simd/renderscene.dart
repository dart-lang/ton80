...
void renderScene(event) {
  var scene = new Scene();
  scene.camera = new Camera(new Vector(0.0, 0.0, -15.0), new Vector(
      -0.2, 0.0, 5.0), new Vector(0.0, 1.0, 0.0));
  scene.background = const Background(const Color(0.5, 0.5, 0.5), 0.4);

  var sphere = new Sphere(new Vector(-1.5, 1.5, 2.0), 1.5, const Solid(
      const Color(0.0, 0.5, 0.5), 0.3, 0.0, 0.0, 2.0));

  var sphere1 = new Sphere(new Vector(1.0, 0.25, 1.0), 0.5, const Solid(
  ...
  var light = new Light(
      new Vector(5.0, 10.0, -1.0), const Color(0.8, 0.8, 0.8));

  var light1 = new Light(
      new Vector(-3.0, 5.0, -15.0), const Color(0.8, 0.8, 0.8), 100.0);
