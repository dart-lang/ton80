...
["", "MergeSort.dart", , G, {
  "^": "",
  main: function() {
    var line = "Template(RunTime): " + H.S(new G.TemplateBenchmark(2000, 10000, "Template").measure$0()) + " us.";
    H.printString(line);
  },
  ...
  mergeSort: function(toSort) {
    ...
    return G.merge(G.mergeSort(J.getInterceptor$a(toSort).sublist$2(toSort, 0, center)), G.mergeSort(C.JSArray_methods.sublist$2(toSort, center, toSort.length)));
  },
  ...
  TemplateBenchmark: {
    "^": "BenchmarkBase;NUMBERS,MAX_NUMBER,name",
    run$0: function() {
      G.mergeSort($.TemplateBenchmark_toSort);
    },
    setup$0: function() {
      $.TemplateBenchmark_toSort = G.createRandomNumbers(this.NUMBERS, this.MAX_NUMBER);
    },
    teardown$0: function() {
    },
...
["benchmark_base", "../../common/dart/BenchmarkBase.dart", , V, {
  ...
  BenchmarkBase: {
    ...
    measure$0: function() {
      ...
      var result = V.BenchmarkBase_measureFor(new V.BenchmarkBase_measure_closure0(this), 2000);
      this.teardown$0();
      return result;
    }
  },
